...
class _$MovieDetailImpl implements _MovieDetail {
  ...
  @override
  String toString() {
    return 'MovieDetail(id: $id, title: $title, posterPath: $posterPath, overview: $overview, backgroundPath: $backgroundPath, runtime: $runtime, voteAverage: $voteAverage, genres: $genres)';
  }
